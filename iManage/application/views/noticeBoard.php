                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                   ...
                                   <form class="form-horizontal" action="#" method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input type="text" class="form-control" id="input-Default" name="title" value="<?php echo $deta->title;?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <?php else:?>
                                	<form class="form-horizontal" action="<?php echo base_url()?>allform/noticeBoard" method="post">
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label">Subject</label>
                                            <div class="col-sm-10">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                	...
                                                	<a href="<?php echo base_url();?>allform/deletenoticeBoard/<?php echo $row->id;?>">Delete</a>
                                                </td>
                                            </tr>
                                            <?php $i++;?>
                                            <?php endforeach;?>
