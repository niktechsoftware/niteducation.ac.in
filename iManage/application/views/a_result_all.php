...
<head>
	...
	$rowc1 = $this->db->get("student_info");
	foreach($rowc1->result() as $info):
	if(substr("$info->student_id", 0, 7) == "NIT1819") {
                                    ...
                                    foreach ($result->result() as $key => $value):
                        		        if($value->s_id != 5 && $value->s_id != 7):
                            		        echo '<tr>';
                            		           ...
                            		           if($value->s_id == 4)
                            		                {$a=$result->result();
                            		                echo '<td align="center">-</td><td align="center">'.$value->max_marks.'</td><td align="center">'.$a[4]->max_marks.'</td>';}
                            		                
                            		            if($value->s_id == 6)
                            		               { $a=$result->result();
                            		                   echo '<td align="center">-</td><td align="center">'.$value->max_marks.'</td><td align="center">'.$a[6]->max_marks.'</td>';}
                            		           ...
                            		           if($value->s_id == 4)
                            		            ...
                            		            if($value->s_id == 4)
                            		               { $a=$result->result();
                            		                   echo '<td align="center">-</td><td align="center">'.$value->marks_obtain.'</td><td align="center">'.$a[4]->marks_obtain.'</td>';}
                            		                
                            		            if($value->s_id == 6)
                            		              {  $a=$result->result();
                            		                  echo '<td align="center">-</td><td align="center">'.$value->marks_obtain.'</td><td align="center">'.$a[6]->marks_obtain.'</td>';}
