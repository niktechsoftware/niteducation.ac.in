                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                                <a href="index-2.html" class="logo-name text-lg text-center">NIT Eduction Admit-Card Section</a>
                                <p class="text-center m-t-md">Please prvoid your student-ID for Admit-Card.</p>
                                <form class="m-t-md" action="<?php echo base_url();?>login/getcard.jsp" method="post">
                                    ...
                                    <?php }?>
                                    <button type="submit" class="btn btn-success btn-block">Get Admit-Card</button>
                                </form>
                            </div>
                        </div>
                    </div><!-- Row -->
