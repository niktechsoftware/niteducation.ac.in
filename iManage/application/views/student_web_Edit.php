                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                 <form class="form-horizontal" action="<?php echo base_url()?>apanel/student_web_Edit" method="post" enctype="multipart/form-data">
                                ...
                                <?php if(($grtid!=0)&&($grtid!=2)&&($grtid!=0)){?>
                                   <form class="form-horizontal" action="<?php echo base_url()?>allform/editSaveRegisterp" method="post" enctype="multipart/form-data">  
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url()?>allform/editSave_web_Register" method="post" enctype="multipart/form-data">
                                        <input class="form-control" type="hidden" name="student_id"  value = "<?php echo $grtid1->student_id;?>" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="total_fee" class="form-control" value = "<?php echo $grtid1->pay_amount;?>" placeholder="Total Course Fee" required="required">
                                            </div>
