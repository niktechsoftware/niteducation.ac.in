            ...
            <div class="container">
                <div class="row">
						...
						<div class="wow bounceInUp col-lg-9 col-md-9 col-sm-9 " data-wow-duration="1s " data-wow-delay="0.5s ">
							<p><p>Download Courses Detail from download Link</p>
						</div>
...
<a href="<?php echo base_url();?>iManage/assets/course/<?php echo $row->coursepdf;?>" alt="Course Notification" target="_blank"><img src="<?php echo base_url();?>assets/images/downloadicon.png" height="50px" width="50px" /></a></span></p>
